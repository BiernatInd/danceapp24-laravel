...
{
    public function userSettingsAccount($userName)
    {
    ...
    public function userChangePassword(Request $request, $userName)
    {
        $request->validate([
    ...
    public function userChangeEmail(Request $request, $userName)
    {
        $request->validate([
            'password' => 'required',
    ...
    public function userDeleteAccount($userName)
    {
        $user = User::where('user_name', $userName)->first();
